# Generated by Django 2.0.6 on 2020-07-07 15:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default='2019-1-1 00:00:00', verbose_name='time')),
                ('createTime', models.DateTimeField(auto_now_add=True, verbose_name='創建時間')),
                ('building', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='apps.Buildings', verbose_name='大廈名稱')),
            ],
            options={
                'verbose_name': '電表數據',
        ...
        migrations.AddField(
            model_name='meters',
            name='rasp',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='apps.Rasps', verbose_name='樹莓派名稱'),
        ),
        migrations.AddField(
            model_name='meterdata',
            name='meter',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='apps.Meters', verbose_name='電表名稱'),
        ),
        migrations.AddField(
            model_name='meterdata',
            name='rasp',
