...
class MeterData(models.Model):
    ...
    time = models.DateTimeField(verbose_name='產生時間')
    createTime = models.DateTimeField(auto_now_add=True, verbose_name='創建時間')
...
class Uplogs(models.Model):
    name = models.CharField(max_length=50, verbose_name='名稱')
    file = models.CharField(max_length=100, verbose_name='文件路徑')
    record_date = models.DateField(verbose_name='文件創建日期')
    status = models.IntegerField(default=0, choices=((1, "解析中"), (0, "待解析"), (2, "解析完成")), verbose_name='狀態')
    createTime = models.DateTimeField(auto_now_add=True, verbose_name='上傳時間')
    building = models.ForeignKey(Buildings,verbose_name='大廈名稱', on_delete=models.CASCADE,default='') 
    rasp = models.ForeignKey(Rasps,verbose_name='樹莓派', on_delete=models.CASCADE,default='') 
    meter = models.ForeignKey(Meters,verbose_name='電錶名稱', on_delete=models.CASCADE,default='') 
